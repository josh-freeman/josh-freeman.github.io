        ...
        userListHtml += `
            <label style="display: flex; align-items: center; gap: 0.5rem; padding: 0.4rem 0; cursor: pointer;" onclick="toggleNotifyUserCheckbox(this)">
                ...
                <span class="custom-checkbox-notify">
                    <svg class="unchecked" width="18" height="18" viewBox="0 0 24 24" style="color: var(--text-muted, #8a857c); ${isChecked ? 'display:none' : ''}"><use href="/resources/icons.svg#checkbox-empty"></use></svg>
                    <svg class="checked" width="18" height="18" viewBox="0 0 24 24" style="color: var(--accent-primary, #e5a54b); ${isChecked ? '' : 'display:none'}"><use href="/resources/icons.svg#checkbox-checked"></use></svg>
                </span>

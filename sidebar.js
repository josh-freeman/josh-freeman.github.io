...
function loadNavbarDiv() {
    ...
    if (isUserLoggedIn()) {
        try {
            ...
            const userPicUrl = user.profile_picture_url;
            const userAvatar = userPicUrl
                ? `<img src="${userPicUrl}" alt="" class="sidebar-account-avatar">`
            ...
            accountWidget = `
                <div class="sidebar-account">
                    <div class="sidebar-account-row">
                        <a href="/profile.html?id=${user.id}" class="sidebar-account-info">
                            ${userAvatar}
                            <span>${userName}</span>
                        </a>
